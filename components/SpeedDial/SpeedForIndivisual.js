...
import { Backdrop, Badge, useMediaQuery } from "@material-ui/core";
    ...
    <div className={classes.root}>
      <div className={classes.exampleWrapper}>
        ...
        <SpeedDial
          ...
          //   className={width ? classes1.speedDial : classes.speedDial}
        ...
        >
          ...
          <SpeedDialAction
            icon={
              <WhatsappShareButton
                url={"https://ciivl.problemspotter.com/statements"}
              >
